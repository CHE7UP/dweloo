      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl">
          ...
          <div className="p-4 md:p-6">
            ...
            <h3 className="text-xl font-semibold text-gray-800">Asana</h3>
            <p className="mt-3 text-gray-500">
        ...
        <div className="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl">
          <div className="h-52 flex flex-col justify-center items-center bg-amber-500 rounded-t-xl">
            ...
            >
              ...
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M32.2661 44.0322C34.035 44.0309 35.4679 42.5953 35.4666 40.8264C35.4679 39.0575 34.035 37.622 32.2661 37.6207H29.0656V40.8264C29.0643 42.594 30.4972 44.0295 32.2661 44.0322ZM32.2661 35.4804H40.7995C42.5684 35.4791 44.0013 34.0436 44 32.2747C44.0026 30.5058 42.5697 29.0702 40.8008 29.0676H32.2674C30.4985 29.0689 29.0656 30.5045 29.0669 32.2734C29.0656 34.0436 30.4972 35.4791 32.2661 35.4804V35.4804Z"
                fill="#ECB22E"
              />
              <path
                fillRule="evenodd"
          ...
          <div className="p-4 md:p-6">
            ...
            <h3 className="text-xl font-semibold text-gray-800">Slack</h3>
            <p className="mt-3 text-gray-500">
