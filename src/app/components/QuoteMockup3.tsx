...
const QuoteMockup3: React.FC = () => {
  ...
  distance="12"
  easing="ease-in-out"
  className="w-[170px] h-[110px] rounded-[20px] shadow-lg p-3 bg-white flex flex-col justify-between border border-gray-200 absolute top-5/7 left-35 right-1 z-10 -translate-y-1/2"
>
  {/* Header */}
