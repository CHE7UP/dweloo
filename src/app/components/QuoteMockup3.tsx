...
const QuoteMockup3: React.FC = () => {
  return (
    <AnimatedContainer 
      ...
      distance="12"
      easing="ease-in-out"
      className="w-[150px] h-[80px] rounded-[20px] shadow-lg p-4 bg-white flex flex-col justify-between border border-gray-200 absolute top-5/7 left-37 right-1 z-10 -translate-y-1/2"
      >
      {/* Header */}
