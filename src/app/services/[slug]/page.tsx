...
export async function generateMetadata({ params }: ServicePageProps) {
  // In Next.js 15, params itself isn't a Promise, but we need to treat params.slug as potentially async
  // We'll use a different approach for type safety
...
export default async function ServiceDetailPage({ params }: ServicePageProps) {
  // Convert params.slug to string to ensure it's handled correctly
  const service = getServiceBySlug(String(params.slug));
