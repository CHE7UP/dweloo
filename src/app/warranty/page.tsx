...
import WarrantyForm from '../components/forms/WarranyForm';
    ...
    <div className="bg-white">
      ...
      <main className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <section className="mb-10">
          <div className="bg-[#1273EB]/10 p-6 rounded-lg border-l-4 border-[#1273EB] mb-6">
          ...
          <h2 className="text-2xl font-semibold text-[#1273EB] mb-4">{intro.headline}</h2>
        ...
        <section className="mb-10">
          ...
          {coverageDetails.map((detail, index) => (
            <div className="mb-6 bg-gray-50 p-5 rounded-lg shadow-sm border border-gray-100" key={index}>
              <h3 className="text-xl font-medium text-[#1273EB] mb-2">{detail.title}</h3>
        ...
        <section className="mb-10">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {serviceWarranties.map((service, index) => (
              <div className="bg-white shadow-md rounded-lg p-6 border-t-4 border-[#1273EB] hover:shadow-lg transition-shadow" key={index}>
                <h3 className="text-xl font-medium text-[#1273EB] mb-3">{service.service}</h3>
        ...
        <section className="mb-10">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white shadow-md rounded-lg p-6 mb-6 md:mb-0 border-t-4 border-[#1976D2] col-span-1">
              <h3 className="text-xl font-medium text-[#1273EB] mb-3">What&apos;s Not Covered</h3>
              <ul className="list-disc pl-5 space-y-2">
            ...
            <div className="bg-white shadow-md rounded-lg p-6 mb-6 md:mb-0 border-t-4 border-[#1976D2] col-span-1">
              <h3 className="text-xl font-medium text-[#1273EB] mb-3">Additional Terms</h3>
              <ul className="list-disc pl-5 space-y-2">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold text-[#1273EB] mb-4">How to Submit a Warranty Claim</h2>
          ...
          <div className="bg-[#1273EB]/10 p-4 rounded-lg border-l-4 border-[#1273EB]">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold text-[#1273EB] mb-4">Frequently Asked Questions</h2>
          
          <div className="space-y-4">
            {faq.map((item, index) => (
              <div className="border border-gray-200 rounded-lg p-5 hover:border-[#1273EB]/30 transition-colors" key={index}>
                <h3 className="text-lg font-medium text-[#1273EB] mb-2">{item.question}</h3>
        ...
        <section id="warranty-claim-form" className="mb-10">
          <h2 className="text-2xl font-semibold text-[#1273EB] mb-4">Warranty Claim Form</h2>
